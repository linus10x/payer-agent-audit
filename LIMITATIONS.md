...
A health payer's coverage / utilization-management decision is a **benefit adjudication under insurance law** — governed by NAIC model guidance and state Departments of Insurance, ERISA (29 CFR 2560.503-1) for self-funded plans, CMS rules (CMS-0057-F) for Medicare Advantage and Medicaid managed care, and the ACA (45 CFR 147.136) for internal/external review. It is a different regulatory world from FDA Software-as-a-Medical-Device (SaMD) and clinical-decision-support regulation, which run from the Federal Food, Drug, and Cosmetic Act as amended by §3060(a) of the 21st Century Cures Act (the statutory exclusion of certain clinical-decision-support software from the device definition).
